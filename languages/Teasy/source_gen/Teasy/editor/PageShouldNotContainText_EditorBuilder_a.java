...
/*package*/ class PageShouldNotContainText_EditorBuilder_a extends AbstractEditorBuilder {
  @NotNull
  private SNode myNode;

  public PageShouldNotContainText_EditorBuilder_a(@NotNull EditorContext context, @NotNull SNode node) {
    super(context);
    myNode = node;
  }
  ...
  private EditorCell createCollection_0() {
    ...
    editorCell.setCellId("Collection_91n3cu_a");
  ...
  private EditorCell createConstant_0() {
    ...
    editorCell.setCellId("Constant_91n3cu_a0");
  ...
  private EditorCell createConstant_1() {
    ...
    editorCell.setCellId("Constant_91n3cu_c0");
    Style style = new StyleImpl();
    style.set(StyleAttributes.INDENT_LAYOUT_INDENT, true);
    editorCell.getStyle().putAll(style);
    editorCell.setDefaultText("");
